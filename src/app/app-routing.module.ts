...
import {NotFoundPageComponent} from "./componet/not-found-page/not-found-page.component";
...
const routes: Routes = [
  ...
  { path: 'console',
    loadChildren: () => import('./modules/console/console.module').then(m => m.ConsoleModule),canActivate:[
      AuthGuard
    ] },
